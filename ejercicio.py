# Importo la librería ktinter, con el alias tk
...
ventana_principal.config(bg="#A93226")
#ventana_principal.iconbitmap('cruz.ico')
...
frame_entrada.config(bg="gray", width=640, height=360)
frame_entrada.pack(fill=tk.BOTH)
# Frame para operaciones
frame_2 = tk.Frame(ventana_principal)
frame_2.config(bg="gray", width=480, height=100)
...
frame_resultados.config(bg="gray", width=480, height=100)
...
#cruz = tk.PhotoImage(file="cruz.png")
#label_cruz = tk.Label(frame_entrada,image=cruz)
#label_cruz.config(bg="#E59866")
#label_cruz.place(x=470,y=80)
#label_cruz.size()
...
titulo.config(bg="gray", fg= "black" , font=("Berlin Sans FB Demi", 32))
titulo.place(x=45,y=20)
# Etiqueta x
label_x = tk.Label(frame_entrada, text="valor X:")
label_x.config(bg="gray",fg="black", font=("Arial", 14))
label_x.place(x=45,y=80)

# Etiqueta y
label_dir = tk.Label(frame_entrada, text="Valor Y:")
label_dir.config(bg="gray",fg="black", font=("Arial", 14))
...
label_info.config(bg="gray",fg="black", font=("Arial", 14))
